    ...
    <section className="panel attack-panel">
      <header className="panel-head attack-head">
        ...
        <p>
          ...
          Decentralized Global Education & Skills Passport waits for R and force-opens all bids.
        </p>
      </header>
      ...
      <div className="attack-columns">
        ...
        <div className="attack-col good">
          <h3>Seal ON — Decentralized Global Education & Skills Passport + Drand tlock</h3>
          <p className="attack-sub">
